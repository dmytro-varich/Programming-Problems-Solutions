...
1. There are **two houses** between the person who likes **Bowling** and the person who likes **Swimming**. <br>
   $$
   \forall i, j \in H, |i - j| \ne 3: Sport(i)=\text{bowling} \rightarrow
   \lnot Sport(j)=\text{swimming}
   $$

2. There is **one house** between the **Irish** and the person who likes **Handball on the left**.<br>
   $$
   \forall i, j \in H, j \ne i + 2: Sport(i)=\text{handball} \rightarrow
   \lnot Nationality(j)=\text{Irish}
   $$
...
3. There are **two houses** between the person who likes **Bowling** and the person who likes **Swimming**:
   ...
   ```text
   (S_1_bowling → ¬S_1_swimming) ∧
   (S_1_bowling → ¬S_2_swimming) ∧
   (S_1_bowling → ¬S_3_swimming) ∧
   
   (S_2_bowling → ¬S_1_swimming) ∧
   (S_2_bowling → ¬S_2_swimming) ∧
   (S_2_bowling → ¬S_3_swimming) ∧
   (S_2_bowling → ¬S_4_swimming) ∧
   
   (S_3_bowling → ¬S_1_swimming) ∧
   (S_3_bowling → ¬S_2_swimming) ∧
   (S_3_bowling → ¬S_3_swimming) ∧
   (S_3_bowling → ¬S_4_swimming) ∧
   
   (S_4_bowling → ¬S_2_swimming) ∧
   (S_4_bowling → ¬S_3_swimming) ∧
   (S_4_bowling → ¬S_4_swimming) 
   ```
...
4. There is **one house** between the **Irish** and the person who likes **Handball on the left**:
   ...
   ```text
   (S_1_handball → ¬N_1_Irish) ∧
   (S_1_handball → ¬N_2_Irish) ∧
   (S_1_handball → ¬N_4_Irish) ∧
   
   (S_2_handball → ¬N_1_Irish) ∧
   (S_2_handball → ¬N_2_Irish) ∧
   (S_2_handball → ¬N_3_Irish) ∧
   
   (S_3_handball → ¬N_1_Irish) ∧
   (S_3_handball → ¬N_2_Irish) ∧
   (S_3_handball → ¬N_3_Irish) ∧
   (S_3_handball → ¬N_4_Irish) ∧
   
   (S_4_handball → ¬N_1_Irish) ∧
   (S_4_handball → ¬N_2_Irish) ∧
   (S_4_handball → ¬N_3_Irish) ∧
   (S_4_handball → ¬N_4_Irish) 
   ```
...
7. The **American** lives **directly to the left** of the person who likes **Turtles**:
   ...
   ```text
   (N_1_American → ¬A_1_turtles) ∧
   (N_1_American → ¬A_3_turtles) ∧
   (N_1_American → ¬A_4_turtles) ∧
   
   (N_2_American → ¬A_1_turtles) ∧
   (N_2_American → ¬A_2_turtles) ∧
   (N_2_American → ¬A_4_turtles) ∧
   
   (N_3_American → ¬A_1_turtles) ∧
   (N_3_American → ¬A_2_turtles) ∧
   (N_3_American → ¬A_3_turtles) ∧
   
   (N_4_American → ¬A_1_turtles) ∧
   (N_4_American → ¬A_2_turtles) ∧
   (N_4_American → ¬A_3_turtles) ∧
   (N_4_American → ¬A_4_turtles)
   ```

8. There are **two houses** between the person who likes **Horses** and the person who likes **Butterflies on the right**:

   ```text
   (A_1_horses → ¬A_1_butterflies) ∧
   (A_1_horses → ¬A_2_butterflies) ∧
   (A_1_horses → ¬A_3_butterflies) ∧
   
   (A_2_horses → ¬A_1_butterflies) ∧
   (A_2_horses → ¬A_2_butterflies) ∧
   (A_2_horses → ¬A_3_butterflies) ∧
   (A_2_horses → ¬A_4_butterflies) ∧
   
   (A_3_horses → ¬A_1_butterflies) ∧
   (A_3_horses → ¬A_2_butterflies) ∧
   (A_3_horses → ¬A_3_butterflies) ∧
   (A_3_horses → ¬A_4_butterflies) ∧
   
   (A_4_horses → ¬A_1_butterflies) ∧
   (A_4_horses → ¬A_2_butterflies) ∧
   (A_4_horses → ¬A_3_butterflies) ∧
   (A_4_horses → ¬A_4_butterflies)
   ```
...
9. The person who likes **Bowling** lives somewhere **to the right** of the person who likes **Tennis**:
   ...
   ```text
   (S_1_bowling → ¬S_1_tennis) ∧
   (S_1_bowling → ¬S_2_tennis) ∧
   (S_1_bowling → ¬S_3_tennis) ∧
   (S_1_bowling → ¬S_4_tennis) ∧
   
   (S_2_bowling → ¬S_2_tennis) ∧
   (S_2_bowling → ¬S_3_tennis) ∧
   (S_2_bowling → ¬S_4_tennis) ∧
   
   (S_3_bowling → ¬S_3_tennis) ∧
   (S_3_bowling → ¬S_4_tennis) ∧
...
10. There is **one house** between the person who likes **Handball** and the **White** house **on the right**:
    ...
    ```text
    (S_1_handball → ¬C_1_white) ∧
    (S_1_handball → ¬C_2_white) ∧
    (S_1_handball → ¬C_4_white) ∧
    
    (S_2_handball → ¬C_1_white) ∧
    (S_2_handball → ¬C_2_white) ∧
    (S_2_handball → ¬C_3_white) ∧
    
    (S_3_handball → ¬C_1_white) ∧
    (S_3_handball → ¬C_2_white) ∧
    (S_3_handball → ¬C_3_white) ∧
    (S_3_handball → ¬C_4_white) ∧
    
    (S_4_handball → ¬C_1_white) ∧
    (S_4_handball → ¬C_2_white) ∧
    (S_4_handball → ¬C_3_white) ∧
    (S_4_handball → ¬C_4_white) 
    ```
...
| 4    | Two houses between Bowling and Swimming                      | 14          |
| 5    | Handball is left of Irish with one house between             | 14          |
| 6    | Second house is Black                                        | 1           |
| 7    | One house between Horses and Red (Red on the right)          | 14          |
| 8    | American is directly left of Turtles                         | 13          |
| 9    | Two houses between Horses and Butterflies (Butterflies on right) | 15          |
| 10   | Bowling is to the right of Tennis                            | 10          |
| 11   | One house between Handball and White (White on the right)    | 14          |
